...
def train(corpus):
    ...
    assert chunk_dist['JJR']=={'I-ADVP': 17, 'I-ADJP': 45, 'I-NP': 204, 'B-ADVP': 63,
                                'B-PP': 2, 'B-ADJP': 111, 'B-NP': 382, 'B-VP': 2,
                                'I-VP': 11, 'O': 16}
    assert chunk_dist['CC']=={'B-ADVP': 3, 'O': 3676, 'I-VP': 104, 'B-CONJP': 6,
                                'I-ADVP': 30, 'I-UCP': 2, 'I-PP': 24, 'I-ADJP': 26,
                                'I-NP': 1409, 'B-ADJP': 2, 'B-NP': 18, 'B-PP': 70,
                                'I-PRT': 1, 'B-VP': 1}
    assert chunk_dist['NN']=={'B-LST': 2, 'I-INTJ': 2, 'B-ADVP': 38, 'O': 37,
    ...
    for pos in chunk_dist.keys():
        pos_chunk[pos] = max(chunk_dist[pos].keys(),key= lambda x: chunk_dist[pos][x])
    print(pos_chunk)
    return pos_chunk
