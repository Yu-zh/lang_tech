...
def predict(test_sentences, feature_names, f_out):
    for test_sentence in test_sentences:
        ...
        for word in X_test_dict:
            word['chunk_n2'] = a
            word['chunk_n1'] = b
            word_test = vec.transform(word)
            y_word_predicted = classifier.predict(word_test)
            y_symbol = dict_classes[y_word_predicted[0]]
            a, b = b, y_symbol
            y_test_predicted_symbols.append(y_symbol)
